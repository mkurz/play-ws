...
lazy val mimaSettings = Seq(
  ...
  mimaBinaryIssueFilters ++= Seq(
    ...
    // Pekko
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.ahc.StandaloneAhcWSClient.apply"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.ahc.StandaloneAhcWSClient.this"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.ahc.StandaloneAhcWSRequest.apply"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.ahc.StandaloneAhcWSRequest.copy"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.ahc.StandaloneAhcWSRequest.this"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.InMemoryBody.apply"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.InMemoryBody.copy"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.InMemoryBody.this"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.SourceBody.apply"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.SourceBody.copy"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.api.libs.ws.SourceBody.this"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.libs.ws.ahc.StandaloneAhcWSClient.create"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.libs.ws.ahc.StandaloneAhcWSClient.this"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.libs.ws.ahc.StandaloneAhcWSRequest.this"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.libs.ws.DefaultBodyWritables.body"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.libs.ws.InMemoryBodyWritable.this"),
    ProblemFilters.exclude[IncompatibleMethTypeProblem]("play.libs.ws.SourceBodyWritable.this"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.ahc.StandaloneAhcWSResponse.bodyAsBytes"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.ahc.StandaloneAhcWSResponse.bodyAsSource"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.ahc.StreamedResponse.bodyAsBytes"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.ahc.StreamedResponse.bodyAsSource"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.InMemoryBody.bytes"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.InMemoryBody.copy$default$1"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.SourceBody.copy$default$1"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.SourceBody.source"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.StandaloneWSResponse.bodyAsBytes"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.api.libs.ws.StandaloneWSResponse.bodyAsSource"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.libs.ws.ahc.StandaloneAhcWSResponse.getBodyAsBytes"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.libs.ws.ahc.StreamedResponse.getBodyAsBytes"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.libs.ws.ahc.StreamedResponse.getBodyAsSource"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.libs.ws.StandaloneWSResponse.getBodyAsBytes"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.libs.ws.StandaloneWSResponse.getBodyAsSource"),
    ProblemFilters.exclude[IncompatibleResultTypeProblem]("play.libs.ws.XML.toBytes"),
    ProblemFilters.exclude[ReversedMissingMethodProblem]("play.api.libs.ws.StandaloneWSResponse.bodyAsBytes"),
    ProblemFilters.exclude[ReversedMissingMethodProblem]("play.api.libs.ws.StandaloneWSResponse.bodyAsSource"),
    ProblemFilters.exclude[ReversedMissingMethodProblem]("play.libs.ws.StandaloneWSResponse.getBodyAsBytes"),
  )
)
